...
interface IMessageListView {
     ...
     * */
    fun sendMessage(msg: IMessageListService.Message, new: Boolean)
     ...
     * */
    fun addNewMessage(message: IMessageListService.Message, toBottom: Boolean = true)

    /**更新文件消息状态*/
    fun notifyFileMessage(message: IMessageListService.Message)
    ...
    /**当前页面显示的消息列表*/
    fun getShowMessageList(): List<IMessageListService.Message>
